...
def compiletrain(mris_training, masks_training, model,function_optmizer):
    ...
    #model.load_weights('/Notebooks/Marianadissertation/Rats/pythonrats3D/bestvalueslasttrain/Teste1/bestweights_vall_acc.hdf5', by_name=False)
...
if __name__ == '__main__':
    ...
    layers=UNET3D_binary.my3DUnet()
    model=layers.create_DL
    #print(model.summary())
    ######  organize files
    #BRAIN SEG
    files=Managefiles3D.myFiles3D(IMAGE_MRI_PATH,IMAGE_MASK_PATH,IMAGE_MASK_BIN_PATH)
