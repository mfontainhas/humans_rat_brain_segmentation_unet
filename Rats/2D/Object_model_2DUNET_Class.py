...
from keras.layers import Input, concatenate, Conv2D, MaxPooling2D, UpSampling2D, Dropout, Cropping3D, Flatten, Dense
...
class my2DUnet:
    ...
    def create_DL_Teste5(self):
        ...
        conv4 = Conv2D(256 * n, (f, f), activation='relu', padding='same', kernel_initializer='he_normal')(drop3)
        ...
        conv99 = Conv2D(32 * n, (f, f), activation='relu', padding='same', kernel_initializer='he_normal')(conv9)
        # conv999 = Conv2D(4, (3,3), activation='relu', padding='same', kernel_initializer='he_normal')(conv99)
        conv10 = Conv2D(4, (1, 1), activation='softmax')(conv99)
...
if __name__ == '__main__':
    ...
    ann_viz(model, view=True, filename="rats2D.gv", title="MyNeural Network");
    
'''
S3 tem drops
    def create_DL_Teste6(self):
        inputs = Input(self.inputsize)
        ...
        up9 = Conv2D(64,(2,2), activation='relu', padding='same', kernel_initializer='he_normal')(UpSampling2D(size=(2, 2))(batch8))
        merge9 = concatenate([conv11, up9], axis=3)
        batch9=BatchNormalization()(merge9)
        ...
        drop99 = Dropout(0.2)(conv9)
        conv10 = Conv2D(4, (1,1), activation='softmax')(drop99)
        model = Model(input=inputs, output=conv10)
        model.load_weights('/Notebooks/Marianadissertation/Rats/pythonrats2D/bestvalueslasttrain/Teste6/bestweights_vall_loss.hdf5', by_name=False)
